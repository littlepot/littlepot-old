...
z=this.Jd
if(z!=null)z.V1(0)
for(z=this.A4,y=z.gUQ(z),x=y.Hb,y=H.VM(new H.MH(null,x.gA(x),y.Oh),[H.Kp(y,0),H.Kp(y,1)]);y.G();)y.Ff.EC()
if(z.hr>0){z.Nz=null
z.In=null
z.Cs=null
z.cG=null
...
z=this.Jc()
if(z==null){if(init.globalState.yc!=null&&init.globalState.i2.x4(0,init.globalState.yc.jO)&&init.globalState.Ai===!0&&init.globalState.yc.A4.hr===0)H.vh(P.FM("Program exited with open ReceivePorts."))
y=init.globalState
...
GE:{
"^":"Tp:9;a",
$1:function(a){return a.h(0,this.a)}}}],["","",,Q,{
"^":"",
Iq:[function(){return Q.hO()},"$0","KW",0,0,7],
BA:{
"^":"a;VY,Zd,Vm,cX,Gx,Nq,Pm,kt,uw,f3,FA,G1,L3,Ev,Px,rz",
je:function(a){var z
if(J.u6(J.xH(a,this.rz),500))z=!0
else{this.rz=a
this.t3()
z=!1}if(z)C.ol.gm6(window).ml(new Q.Cb(this))},
Fl:function(){var z,y,x,w,v
z=this.Vm
y=z.value
if(!H.v4("^([a-zA-Z][0-9_\\-a-zA-Z]*)$",!1,!0,!1).test(H.Yx(z.value))){this.tb("Room name is not valid")
return}else{z="/rs/session/"+H.d(y)+"/"
x=z+(this.Px?"cross":"circle")
w=new XMLHttpRequest()
C.Dt.EP(w,"POST",x)
z=H.VM(new W.RO(w,"loadend",!1),[null])
v=z.gFV(z).ml(new Q.y6(this,w))
w.send()
this.tb("Creating new room...")
return v}},
av:function(a){var z
if(a.status!==200){P.JS("ERROR recepcion servidor")
this.tb("Error "+H.d(a.status))
return}else{z=a.responseText.split("#")
if(0>=z.length)return H.e(z,0)
this.L3=H.BU(z[0],null,null)
this.tb("Room created successfully.")
J.pP(document.querySelector("#step-room")).h(0,"hidden")
J.pP(document.querySelector("#step-wait")).Rz(0,"hidden")
this.t3()}},
b7:function(){var z,y,x,w
z="/rs/session/"+H.d(this.Vm.value)
y=new XMLHttpRequest()
C.Dt.EP(y,"POST",z)
x=H.VM(new W.RO(y,"loadend",!1),[null])
w=x.gFV(x).ml(new Q.kK(this,y))
y.send()
this.tb("Joining existing room...")
return w},
...
this.L3=H.BU(J.rr(y[0]),null,null)
if(1>=y.length)return H.e(y,1)
x=J.rr(y[1])
w=this.Ev
w.setItem("cinco_session",J.AG(this.L3))
w.setItem("cinco_player",x)
this.tb("Room joined successfully, playing as "+x+".")
J.pP(document.querySelector("#step-room")).h(0,"hidden")
J.pP(document.querySelector("#step-play")).Rz(0,"hidden")}},
t3:function(){var z,y,x,w
z="/rs/session/"+H.d(this.L3)
y=new XMLHttpRequest()
C.Dt.EP(y,"GET",z)
x=H.VM(new W.RO(y,"loadend",!1),[null])
w=x.gFV(x).ml(new Q.Sa(this,y))
y.send()
return w},
...
v=J.rr(y[3])
if("true"===w)this.tb("The room has been left.")
else if("true"===x){x=this.Ev
x.setItem("cinco_session",J.AG(this.L3))
x.setItem("cinco_player",v)
this.tb("Your opponent joined the room. Let's play!")
J.pP(document.querySelector("#step-wait")).h(0,"hidden")
J.pP(document.querySelector("#step-play")).Rz(0,"hidden")}else{this.tb("Waiting for a player to join...")
C.ol.gm6(window).ml(new Q.cI(this))}}},
oh:function(){var z,y,x,w
z="/rs/session/"+H.d(this.L3)+"/leave"
y=new XMLHttpRequest()
C.Dt.EP(y,"POST",z)
x=H.VM(new W.RO(y,"loadend",!1),[null])
w=x.gFV(x).ml(new Q.ys(this,y))
y.send()
this.tb("Leaving room...")
return w},
eg:function(a){var z
if(a.status!==204){P.JS("ERROR recepcion servidor")
this.tb("Error "+H.d(a.status))
return!1}else{z=this.Ev
J.w1(z).Rz(z,"cinco_session")
C.uy.Rz(z,"cinco_player")
this.tb("Room left successfully")
J.pP(document.querySelector("#step-wait")).h(0,"hidden")
J.pP(document.querySelector("#step-play")).h(0,"hidden")
J.pP(document.querySelector("#step-back")).Rz(0,"hidden")
return!0}},
tb:function(a){var z=this.G1
z.textContent=a
z.toString
new W.I4(z).Rz(0,"hidden")},
ji:function(){var z=this.cX
z.toString
z=H.VM(new W.Cq(z,"click",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new Q.ND(this)),z.el),[H.Kp(z,0)]).DN()
z=this.Gx
z.toString
z=H.VM(new W.Cq(z,"click",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new Q.QE(this)),z.el),[H.Kp(z,0)]).DN()
z=this.VY
z.toString
z=H.VM(new W.Cq(z,"click",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new Q.YE(this)),z.el),[H.Kp(z,0)]).DN()
z=this.Zd
z.toString
z=H.VM(new W.Cq(z,"click",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new Q.D5(this)),z.el),[H.Kp(z,0)]).DN()
z=this.kt
z.toString
z=H.VM(new W.Cq(z,"click",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new Q.li(this)),z.el),[H.Kp(z,0)]).DN()
z=this.uw
z.toString
z=H.VM(new W.Cq(z,"click",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new Q.bk(this)),z.el),[H.Kp(z,0)]).DN()
z=this.f3
z.toString
z=H.VM(new W.Cq(z,"click",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new Q.aC(this)),z.el),[H.Kp(z,0)]).DN()
z=this.FA
z.toString
z=H.VM(new W.Cq(z,"click",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new Q.oW(this)),z.el),[H.Kp(z,0)]).DN()},
static:{hO:function(){var z=new Q.BA(H.Go(document.querySelector("#tab-create"),"$isGh"),H.Go(document.querySelector("#tab-join"),"$isGh"),H.Go(document.querySelector("#room-name"),"$isMi"),H.Go(document.querySelector("#start-cross"),"$isGh"),H.Go(document.querySelector("#start-circle"),"$isGh"),H.Go(document.querySelector("#play-cross"),"$isSN"),H.Go(document.querySelector("#play-circle"),"$isSN"),H.Go(document.querySelector("#new-room"),"$isGh"),H.Go(document.querySelector("#join-room"),"$isGh"),H.Go(document.querySelector("#cancel-wait"),"$isGh"),H.Go(document.querySelector("#leave-room"),"$isGh"),H.Go(document.querySelector("#message"),"$isSN"),null,window.sessionStorage,!0,0)
z.ji()
return z}}},
ND:{
"^":"Tp:9;a",
...
y=z.VY
y.toString
new W.I4(y).h(0,"disabled")
z=z.Zd
z.toString
new W.I4(z).Rz(0,"disabled")
J.pP(document.querySelector("#title-join")).h(0,"hidden")
J.pP(document.querySelector("#title-create")).Rz(0,"hidden")
J.pP(document.querySelector("#label-join")).h(0,"hidden")
J.pP(document.querySelector("#label-create")).Rz(0,"hidden")
J.pP(document.querySelector("#choose-player")).Rz(0,"hidden")
J.pP(document.querySelector("#join-room")).h(0,"hidden")
J.pP(document.querySelector("#new-room")).Rz(0,"hidden")
return}},
D5:{
"^":"Tp:9;d",
$1:function(a){var z,y
...
J.pP(document.querySelector("#title-create")).h(0,"hidden")
J.pP(document.querySelector("#title-join")).Rz(0,"hidden")
J.pP(document.querySelector("#label-create")).h(0,"hidden")
J.pP(document.querySelector("#label-join")).Rz(0,"hidden")
J.pP(document.querySelector("#choose-player")).h(0,"hidden")
J.pP(document.querySelector("#new-room")).h(0,"hidden")
J.pP(document.querySelector("#join-room")).Rz(0,"hidden")
return}},
li:{
"^":"Tp:9;e",
$1:function(a){return this.e.Fl()}},
bk:{
"^":"Tp:9;f",
$1:function(a){return this.f.b7()}},
aC:{
"^":"Tp:9;UI",
$1:function(a){return this.UI.oh()}},
oW:{
"^":"Tp:9;bK",
$1:function(a){return this.bK.oh()}},
Cb:{
"^":"Tp:19;a",
$1:function(a){return this.a.je(a)}},
y6:{
"^":"Tp:9;a,b",
$1:function(a){return this.a.av(this.b)}},
kK:{
"^":"Tp:9;a,b",
$1:function(a){return this.a.mV(this.b)}},
Sa:{
"^":"Tp:9;a,b",
...
ys:{
"^":"Tp:9;a,b",
$1:function(a){return this.a.eg(this.b)}}},1],])
...
init.metadata=[{func:"uO",args:[P.qU]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},{func:"c7",args:[P.FK]},];$=null
